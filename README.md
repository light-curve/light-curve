...
- [`python/light-curve`](./python/light-curve) [![PyPI version](https://badge.fury.io/py/light-curve.svg)](https://pypi.org/project/light-curve/) Python bindings to `light-curve-dmdt` and `light-curve-feature`
